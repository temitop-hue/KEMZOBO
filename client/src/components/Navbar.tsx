...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#7F1D1D] shadow-lg shadow-[#7F1D1D]/10">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/cart" className="relative">
              ...
              {itemCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-white text-[#7F1D1D] text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center">
                  {itemCount}
                </span>
              )}
            </Link>
