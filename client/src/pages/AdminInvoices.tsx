...
import { Plus, X, Trash2, Send, CheckCircle2, Printer, FileText } from "lucide-react";
        ...
        <div className="border-t border-border bg-[#FAFAFA] px-6 py-4 flex flex-wrap items-center gap-2 print:hidden">
          ...
          {invoice.status !== "cancelled" && invoice.status !== "paid" && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-border text-muted-foreground px-4 py-2 text-sm font-medium hover:bg-muted transition-colors"
            >
              Cancel invoice
            </button>
          )}
