  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
      ...
      <div className="max-w-2xl mb-12">
        <p className="text-[#F87171] font-bold text-sm uppercase tracking-[0.3em] font-medium mb-4">Shop</p>
        <div className="flex items-center gap-3 mb-4"><div className="w-1 h-10 rounded-full bg-[#F87171]" />
