  ...
  if (items.length === 0) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 text-center">
        ...
        <Link
          href="/products"
          className="inline-block rounded-lg bg-[#DC2626] hover:bg-[#EF4444] text-white px-6 py-2.5 font-semibold transition-colors"
        >
          Browse Products
        </Link>
      </div>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <div className="mt-6 flex gap-4">
          ...
          <Link
            href="/checkout"
            className="flex-1 rounded-lg bg-[#DC2626] hover:bg-[#EF4444] text-white px-6 py-2.5 text-center font-semibold transition-colors"
          >
            Proceed to Checkout
          </Link>
        </div>
