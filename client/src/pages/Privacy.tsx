  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
      ...
      <div className="prose prose-neutral max-w-none text-muted-foreground space-y-6 text-sm leading-relaxed">
        ...
        <h2 className="font-display text-xl font-bold text-[#CC2936] mt-8 mb-3">Information We Collect</h2>
        <p>
        ...
        <h2 className="font-display text-xl font-bold text-[#CC2936] mt-8 mb-3">How We Use Your Information</h2>
        ...
        <h2 className="font-display text-xl font-bold text-[#CC2936] mt-8 mb-3">Payment Security</h2>
        <p>
        ...
        <h2 className="font-display text-xl font-bold text-[#CC2936] mt-8 mb-3">Cookies</h2>
        <p>
        ...
        <h2 className="font-display text-xl font-bold text-[#CC2936] mt-8 mb-3">Your Rights</h2>
        <p>
