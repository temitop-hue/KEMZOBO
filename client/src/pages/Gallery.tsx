        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex items-center">
            <div className="max-w-xl px-10 lg:px-16">
              ...
              <Link
                href="/products"
                className="btn-primary group inline-flex items-center gap-2 rounded-full bg-white text-hibiscus px-8 py-3.5 font-bold hover:bg-gray-100 transition-colors"
              >
