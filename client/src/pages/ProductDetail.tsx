              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="btn-primary flex-1 flex items-center justify-center gap-2 rounded-full bg-[#DC2626] text-white px-6 py-4 font-bold text-lg hover:bg-[#EF4444] transition-all"
                  >
